...
public class AnimalDaoTest {
    ...
    public void insertAnimal() throws Exception {
        Animal animal = new Animal("Jerry", "Dog", "dog1", "Samoyed", "3 years", "Male");
    ...
    public void insertTwoAnimals() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "3 years", "Male");
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "2 years", "Female");
    ...
    public void insertMultipleAnimals() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "3 years", "Male");
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "2 years", "Female");
        Animal animal3 = new Animal("Tim", "Dog", "dog3", "Corgi", "3 years", "Male");
    ...
    public void findByType() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "3 years", "Male");
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "2 years", "Female");
        Animal animal3 = new Animal("Tim", "Cat", "cat1", "Persian", "5 years", "Male");
        animalDao.insert(animal1, animal2, animal3);
