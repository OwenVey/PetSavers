...
public class AnimalDaoTest {
    ...
    public void insertAnimal() throws Exception {
        Animal animal = new Animal("Jerry", "Dog", "dog1", "Samoyed", "Young", "Male", 10, "Black", 0);
    ...
    public void insertTwoAnimals() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "Young", "Male", 10, "Black", 0);
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "Puppy", "Female", 15, "White", 0);
    ...
    public void insertMultipleAnimals() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "Young", "Male", 10, "Black", 0);
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "Young", "Female", 15, "White", 0);
        Animal animal3 = new Animal("Tim", "Dog", "dog3", "Corgi", "Puppy", "Male", 23, "Tan", 0);
    ...
    public void findByType() throws Exception {
        Animal animal1 = new Animal("Jerry", "Dog", "dog1", "Samoyed", "Young", "Male", 10, "Black", 0);
        Animal animal2 = new Animal("Sadie", "Dog", "dog2", "Black Lab", "Young", "Female", 15, "White", 0);
        Animal animal3 = new Animal("Tim", "Cat", "dog3", "Corgi", "Puppy", "Male", 23, "Tan", 0);
        animalDao.insert(animal1, animal2, animal3);
    ...
    @Test
    public void updateFavorited() throws Exception {
        Animal animal = new Animal("Jerry", "Dog", "dog1", "Samoyed", "Young", "Male", 10, "Black", 0);
        animalDao.insert(animal);

        Animal test = animalDao.findByName("Jerry");

        assertEquals(0, test.favorited);

        test.favorited = 1;
        animalDao.update(test);

        Animal test2 = animalDao.findByName("Jerry");
        assertEquals(1, test2.favorited);
    }
}
